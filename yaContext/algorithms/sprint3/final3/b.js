...
По итогу, массив делится на две части: одна с элементами меньше опорного и другая с элементами больше опорного
Далее алгоритм рекурсивно применяется к каждой из этих частей

В качестве опорного элемента берем я взял, тот что по середине
